    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!--<form>-->
            ...
            <?php echo form_open_multipart('smsapi/notitemplate_details','class="form-inner"') ?>                      
...
<div class="form-group col-sm-12">
            ...
            <input class="form-control" name="template_name" type="text" required="" value="<?php echo $tlist->template_name; ?>"> 
                ...
                <div class="form-group col-sm-6"> 
                  ...
                  <label>Template For All User
                  <input type="checkbox" class="form-control" name="display" id="display" value="<?php echo $tlist->display_setting; ?>" <?php if($tlist->display_setting=='1'){ echo 'checked';} ?>></label>
                </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!--<form>-->
            ...
            <?php echo form_open_multipart('smsapi/createtemplatenoti','class="form-inner"') ?>                      
            ...
            <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="form-group col-sm-6"> 
                  ...
                  <label>Template For All User
                  <input type="checkbox" class="form-control" name="display" id="display" value="1"></label>
                </div>
