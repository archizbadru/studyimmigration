...
<div id="footer1"> 
<label for="acc-or">
<?php echo $client_aggrement_form['CLIENT_AGREEMENT_DETAILS']['signing_party']; ?>
</br>
</label>
</div>
<div class="row">
...
<div class="col-md-12">
<p>THIS SERVICE AGREEMENT IS EXECUTED at Ernakulam on the <?php $date = strtotime($client_aggrement_form['CLIENT_AGREEMENT_DETAILS']['expected_signing_date']); echo date('l jS F Y', $date) ?> (<?php echo $client_aggrement_form['CLIENT_AGREEMENT_DETAILS']['expected_signing_date']; ?>) BETWEEN M/s. GODSPEED IMMIGRATION AND STUDY ABROAD PVT LTD, CIN: U74999KL2018PTC054866 </p>
</div>
...
<p><?php echo $client_aggrement_form['CLIENT_AGREEMENT_DETAILS']['signing_party']; ?>, S/o <?php echo $client_aggrement_form['CLIENT_AGREEMENT_DETAILS']['father_name']; ?>, <?php echo $client_aggrement_form['CLIENT_AGREEMENT_DETAILS']['address_of_sign_party']; ?> (hereinafter referred to as <label for="acc-or">CLIENT</label> )</br> 
...
<label for="acc-or">CLIENT </label> is an individual who approached the Godspeed Immigration for availing their consulting services, advisory services, guidance and assistance in applying for <?php echo $client_aggrement_form['CLIENT_AGREEMENT_DETAILS']['assistance_visa_category']; ?> However, the Client can include additional applicant / members during the process, subject to terms and conditions agreed upon by the parties.</p>
</div>
...
<p> <?php echo $client_aggrement_form['CLIENT_AGREEMENT_DETAILS']['consultancy_fees']; ?> </p>
<p> <?php echo $client_aggrement_form['CLIENT_AGREEMENT_DETAILS']['others']; ?></p>
