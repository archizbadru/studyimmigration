...
<!------ Filter Div ---------->
        ...
        <div class="col-lg-12">          
            <div class="panel panel-default">
                <div class="panel-heading no-print">
                  <div class="btn-group"> 
                      <a class="btn btn-primary" href="<?php echo base_url("report/call_report") ?>"> <i class="fa fa-list"></i>  <?php echo display('reports_list') ?> </a>
                  </div>
              </div>
                <div class="panel-body">
                    ...
                    <form method="post" class="lead-form" id="filter_and_save_form" action="<?php echo base_url('Report/telephony_mgmt') ?>">
  ...
  <option value="4" <?php if(!empty(set_value('state'))){ if (in_array('4',set_value('state'))) {echo 'selected';}}?>>Refund Case</option>
                ...
                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Agent No',set_value('report_columns'))) {echo 'selected';}}?> selected>Agent No</option>

                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Applicant No',set_value('report_columns'))) {echo 'selected';}}?> selected>Applicant No</option>

                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Call At',set_value('report_columns'))) {echo 'selected';}}?> selected>Call At</option>

                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Call End At',set_value('report_columns'))) {echo 'selected';}}?> selected>Call End At</option>

                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Duration',set_value('report_columns'))) {echo 'selected';}}?> selected>Duration</option>

                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Call Status',set_value('report_columns'))) {echo 'selected';}}?> selected>Call Status</option>
 ...
 $("#filter_and_save_form").on('submit',function(e){
  ...
  $(document).ready(function(){   
    ...
    $('#example').DataTable({         
      ...
      "ajax": {
          "url": "<?=base_url().'report/all_report_filterdata/5'?>",
          "type": "POST",
      },    
...
$("#filter_and_save").on("click",function(e){
  ...
  if(title){    
    var url = "<?=base_url().'report/create_report/5'?>";
    $.ajax({
      url:url,
      type:'POST',
      data:{
