...
<!------ Filter Div ---------->
        ...
        <div class="col-lg-12">          
            <div class="panel panel-default">
                <div class="panel-heading no-print">
                  <div class="btn-group"> 
                      <a class="btn btn-primary" href="<?php echo base_url("report/legal_report_list") ?>"> <i class="fa fa-list"></i>  <?php echo display('reports_list') ?> </a>
                  </div>
              </div>
                <div class="panel-body">
                    ...
                    <form method="post" class="lead-form" id="filter_and_save_form" action="<?php echo base_url('Report/legal_mgmt') ?>">
  ...
  <option value="4" <?php if(!empty(set_value('state'))){ if (in_array('4',set_value('state'))) {echo 'selected';}}?>>Refund Case</option>
                ...
                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Aggrement Name',set_value('report_columns'))) {echo 'selected';}}?> selected>Aggrement Name</option>

                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Aggrement Status',set_value('report_columns'))) {echo 'selected';}}?> selected>Aggrement Status</option>

                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Signed File',set_value('report_columns'))) {echo 'selected';}}?> selected>Signed File</option>

                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Aggrement Created Date',set_value('report_columns'))) {echo 'selected';}}?> selected>Aggrement Created Date</option>
 ...
 $("#filter_and_save_form").on('submit',function(e){
  ...
  $(document).ready(function(){   
    ...
    $('#example').DataTable({         
      ...
      "ajax": {
          "url": "<?=base_url().'report/all_report_filterdata/4'?>",
          "type": "POST",
      },    
...
$("#filter_and_save").on("click",function(e){
  ...
  if(title){    
    var url = "<?=base_url().'report/create_report/4'?>";
    $.ajax({
      url:url,
      type:'POST',
      data:{
