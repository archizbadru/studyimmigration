        ...
        <div class="col-lg-12">          
            <div class="panel panel-default">
                <div class="panel-heading no-print">
                  <div class="btn-group"> 
                      <a class="btn btn-primary" href="<?php echo base_url("report/case_report_list") ?>"> <i class="fa fa-list"></i>  <?php echo display('reports_list') ?> </a>
                ...
                <div class="panel-body">
                    ...
                    <form method="post" class="lead-form" id="filter_and_save_form" action="<?php echo base_url('Report/case_mgmt') ?>">
 ...
 $("#filter_and_save_form").on('submit',function(e){
  ...
  $(document).ready(function(){   
    ...
    $('#example').DataTable({         
      ...
      "ajax": {
          "url": "<?=base_url().'report/all_report_filterdata/3'?>",
          "type": "POST",
      },    
...
$("#filter_and_save").on("click",function(e){
  ...
  if(title){    
    var url = "<?=base_url().'report/create_report/3'?>";
    $.ajax({
      url:url,
      type:'POST',
      data:{
