         ...
         <div class="panel-body">
               <div class="tab-content clearfix">                  
                  <div class="tab-pane active" id="tab-templates">
                     <br>
                     <button class="btn btn-sm btn-success" style="float: left" type="button" data-toggle="modal" data-target="#createnewtemplate"><i class="fa fa-plus"></i> Add New Visa Type</button>
                     <br>
                     <br>
                        ...
                        <table width="100%" class="datatable table table-striped table-bordered table-hover">
                           <thead>
                              <tr>
                                 ...
                                 <th  nowrap>Visa Type Name</th>
                              </tr>
                           </thead>
                           <tbody>
                              <?php if (!empty($visa_type)) { ?>
                              <?php $sl = 1; ?>
                              <?php foreach ($visa_type as $tlist) { ?>
                              <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>" style="cursor:pointer;" data-toggle="modal" data-target="#createnewtemplate<?php echo $tlist->id;?>">
                                 ...
                                 <td class="th1"><?php echo $tlist->visa_type; ?></td>
                              </tr>
                              <?php $sl++; ?>
                              <?php } ?> 
                              <?php } ?> 
                        ...
                        <div class="modal-dialog modal-lg">
                           ...
                           <div class="modal-content" >
                              <div class="modal-header">
                                 ...
                                 <h4 class="modal-title">Edit <?php echo $tlist->visa_type; ?></h4>
                              </div>
                              <div class="modal-body">
                                 <!--<form>-->
                                 <?php echo form_open_multipart('lead/visa_type_update','class="form-inner"') ?>                      
                                 <div class="row">
                                    <input type="hidden" name="test_id" value="<?php echo $tlist->id; ?>">
                                    <div class="form-group   col-sm-12">
                                       <label>Visa Type Name*</label>
                                       <input class="form-control" name="visa_type" type="text" required="" value="<?php echo $tlist->visa_type; ?>"> 
                                    </div>
                                 </div>
...
<div id="createnewtemplate" class="modal fade" role="dialog">
   <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Create New Visa Type</h4>
         </div>
         <div class="modal-body">
            <!--<form>-->
            <?php echo form_open_multipart('lead/create_visa_type','class="form-inner" id="create_visa_type"') ?>                      
            <div class="row">
               <div class="form-group col-sm-6">
                  <label>Visa Type Name*</label>
                  <input class="form-control" name="visa_type" type="text" required="">
               </div>
            </div>
...
<script>   
   ...
   url: '<?php echo base_url();?>lead/delete_visa_type',
