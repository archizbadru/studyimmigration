...
<?php }else{ ?>
  <title>Study immigration - <?php echo (!empty($title)?$title:null) ?></title>
<?php } ?>
...
<?php } ?>
      ...
      <script src="<?php echo base_url('assets/js/jquery.min.js?v=1.0') ?>" type="text/javascript"></script>
       <script>
        function send_parameters(phn,enq_id){
			var x=phn.toString().length;
           if(x >= 10){			
            var url="<?=base_url().'telephony/click_to_dial/'?>" + phn+'/'+enq_id; 
              $.ajax({
                  url:url,
                  type: 'POST',
                   beforeSend: function(){
				...
				//	console.log(res);
                    ...
                    if (result.value) {                                 
							 ...
							 Swal.fire({            
					// icon: 'info',
					 html:'<strong>Connected <blink>..</blink></strong>',
					 showCancelButton: false,
					 confirmButtonColor: '#3085d6',
					 cancelButtonColor: '#d33',
					 confirmButtonText: 'ok'              
    ...
    function send_parameter(phn){
			var x=phn.toString().length;
           if(x >= 10){			
            var url="<?=base_url().'telephony/config_join/'?>" + phn; 
              $.ajax({
                  url:url,
                  type: 'POST',
                    beforeSend: function(){
				...
				//	console.log(res);
					if(res.status=='error'){
					 Swal.fire({            
					// icon: 'info',
					 html:'<strong>Disconnected <blink>..</blink></strong>',
					 showCancelButton: false,
					 confirmButtonColor: '#3085d6',
					 cancelButtonColor: '#d33',
					 confirmButtonText: 'ok'              
		...
		function send_parameters2(phn){
			var x=phn.toString().length;
           if(x >= 10){			
            var url="<?=base_url().'telephony/conf_dail/'?>" + phn; 
              $.ajax({
                  url:url,
                  type: 'POST',
                    beforeSend: function(){
      ...
      <div class="wrapper">
         <header class="main-header" >
            ...
            <a href="<?php echo base_url('dashboard/home') ?>" class="logo" >
              ...
              // echo $segment1;
              // echo $segment2;
               if(($segment1=='payment' AND $segment2=='pay_method') || ($segment1=='dashboard' AND $segment2=='user_profile')){ ?>
               <?php if($comp_id==88){ ?>
                <span class="logo-mini">
  <img src="<?php echo base_url("assets/images/logo_cryez.png") ?>" alt="" style="padding-bottom: 10px;">
               </span>
               <span class="logo-lg">
  <img src="<?php echo base_url("assets/images/logo_cryez.png") ?>" alt="" style="padding-bottom: 10px;">
               </span> 
             <?php }else if($comp_id==83){ ?>
              <span class="logo-mini">
    ...
    overflow-y: auto;">
         ...
         <?php if(!in_array($this->session->userdata('user_right'), applicant)){ ?>
                  <li class="<?php echo (($segment1 == 'dashboard') ? "active" : null) ?>">
                     ...
                     <i class="fa fa-home" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('dashboard') ?>
           <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('dashboard') ?></p> <?php } ?>
                     </a>
                  </li>
         <?php } ?>
            ...
            <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('lead_master_search') ?></p> <?php } ?>
                  ...
                  <li class="treeview <?php echo (($segment1 == "location" AND in_array($segment2,array('country')) ) ? "active" : null) ?>" style="<?php if(in_array(10,$module) || in_array(11,$module) || in_array(12,$module) || in_array(12,$module)){ echo 'display:block;'; }else{ 
                    echo 'display:none;'; } ?>" >
                     <a href="#">
                       <i class="fa fa-map-marker" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> <?php echo display("location_setting"); ?>
                       <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                       </span>
             <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('location_setting'); ?></p> <?php } ?>
                     </a>
                     <ul class="treeview-menu <?php echo (($segment1 == "location") ?"menu-open":'') ?>">
                        <li class="<?php echo (in_array($segment2,array('country','edit_contry')) ?"active":'') ?>">
                          <a href="<?php echo base_url("location/country") ?>"><?php echo display('country_list') ?></a>
                        </li>

                        <li class="<?php echo (in_array($segment2,array('region','add_region','edit_region')) ?"active":'') ?>">
                          <a href="<?php echo base_url("location/region") ?>"><?php echo display('region_list') ?></a>
                        </li>

                        <li class="<?php echo (in_array($segment2,array('state','add_state','edit_state')) ?"active":'') ?>">
                          <a href="<?php echo base_url("location/state") ?>"><?php echo display('state_list') ?></a>
                        </li>

                        <li class="<?php echo (in_array($segment2,array('territory','add_territory','edit_territory')) ?"active":'') ?>">
                          <a href="<?php echo base_url("location/territory")?>"><?php echo display('territory_list') ?></a>
                        </li>
                        
                        <li class="<?php echo (in_array($segment2,array('city','add_city','edit_city')) ?"active":'') ?>">
          ...
          <li class="treeview <?php echo ((in_array($segment2,array('country_vs_stream','stream','country_vs_document','document') ) ) ? "active" : null) ?>" style="<?php if(in_array(510,$module) || in_array(511,$module) || in_array(512,$module) || in_array(512,$module)){ echo 'display:block;'; }else{ 
                    echo 'display:none;'; } ?>" >
                     <a href="#">
                       <i class="fa fa-folder-open-o" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> <?php echo display("dcoument_setting"); ?>
                       <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                       </span>
                    <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('dcoument_setting'); ?></p> <?php } ?>
                     </a>
                     <ul class="treeview-menu <?php echo (($segment2 == "country_vs_document") ?"menu-open":'') ?>">
                        <li class="<?php echo (in_array($segment2,array('country_vs_document','document')) ?"active":'') ?>">
                          <a href="<?php echo base_url("location/country_vs_document") ?>"><?php echo display('countrytodoctype') ?></a>
                        </li>
                        <li class="<?php echo (in_array($segment2,array('country_vs_stream','stream')) ?"active":'') ?>">
                          <a href="<?php echo base_url("location/country_vs_stream") ?>"><?php echo display('countrytodocstream') ?></a>
                        </li>
                        <li class="<?php echo (in_array($segment2,array('country_vs_file','file')) ?"active":'') ?>">
                          <a href="<?php echo base_url("location/country_vs_file") ?>"><?php echo display('countrytodocfile') ?></a>
                        </li>
                     </ul>
                  </li>
          
                  <li class="treeview <?php echo (($segment1 == "lead" && $segment2 != "index" && $segment2 != "lead_details") ? "active" : null) ?>" style="<?php if(in_array(30,$module) || in_array(31,$module) || in_array(32,$module) || in_array(33,$module) ){ echo 'display:block;';}else{echo 'display:none;';}?>">
                     <a href="#">
                     <i class="fa fa-line-chart" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> <?php echo display("sales_setting"); ?>
                     <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span>
           <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('sales_setting'); ?></p> <?php } ?>
                     ...
                     <ul class="treeview-menu <?php echo (($segment1 == "lead" && $segment2 != "index" && $segment2 != "lead_details") ?"menu-open":'') ?>">
                        <li class="<?php echo (in_array($segment1,array('leadRules')) ?"active":'') ?>">
                        ...
                        <li class="<?php echo (in_array($segment2,array('desp_type')) ?"active":'') ?>">
                          <a href="<?php echo base_url(); ?>lead/desp_type"> <?php echo "Disposition Type"; ?> </a>
                        </li>

                        <li class="<?php echo (in_array($segment2,array('stage_mapping')) ?"active":'') ?>">
                          <a href="<?php echo base_url(); ?>lead/stage_mapping"> <?php echo display("lead_stage_mapping"); ?> </a>
                        </li>
                        ...
                        <li class="<?php echo (in_array($segment2,array('lead_source')) ?"active":'') ?>">
                          <a href="<?php echo base_url(); ?>lead/lead_source"><?php echo display('lead_source'); ?></a>
                        </li>
                        
                        <li class="<?php echo (in_array($segment2,array('subsourcelist','add_subsource','edit_subsource')) ?"active":'') ?>"><a href="<?php echo base_url() ?>lead/subsourcelist">
                           <?php echo display('subsource_management');?></a>
                        </li>

                        <li class="<?php echo (in_array($segment2,array('add_drop')) ?"active":'') ?>">
                          <a href="<?php echo base_url(); ?>lead/add_drop"><?php echo display('drop_reason'); ?></a>
                        </li>

                        <li class="<?php echo (in_array($segment2,array('load_customer_channel_mater')) ?"active":'') ?>">
                          <a href="<?php echo base_url('lead/load_customer_channel_mater'); ?>"><?php echo display('enquiry_type'); ?></a>
                        </li>
...
<?php } ?>                       
                        ...
                        <li class="<?php echo (in_array($segment2,array('productcountry','addproductcountry','edit_institute')) ?"active":'') ?>">
...
<?php if($this->session->userdata('companey_id')==67 || $this->session->userdata('companey_id')==76 || $this->session->userdata('companey_id')==84) { ?>
            ...
            <li class="<?php echo (in_array($segment2,array('levellist','add_level','edit_level')) ?"active":'') ?>">
                          <a href="<?php echo base_url() ?>lead/level">
                           <?php echo display('program_level');?>                             
                          </a>
                        </li>
            <li class="<?php echo (in_array($segment2,array('lengthlist','add_length','edit_length')) ?"active":'') ?>">
...
<?php } ?>
      ...
      <li class="<?php echo (in_array($segment2,array('sub_course','add_sub_course','edit_sub_course')) ?"active":'') ?>" style="<?php if(in_array(350,$module) || in_array(351,$module) || in_array(352,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
            ...
            <li class="<?php echo (in_array($segment2,array('courselist','add_course','edit_course')) ?"active":'') ?>" style="<?php if(in_array(350,$module) || in_array(351,$module) || in_array(352,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                        ...
                        <li class="<?php echo (in_array($segment2,array('centerlist','add_center','edit_center')) ?"active":'') ?>" style="<?php if(in_array(0,$module) || in_array(0,$module) || in_array(0,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                        ...
                        <li class="<?php echo (in_array($segment2,array('agreement_template')) ?"active":'') ?>">
                          <a href="<?php echo base_url('lead/agreement_template'); ?>">
                           <?php echo 'Agreement template';?>                            
                          </a>
                        </li>
            
                        <li class="<?php echo (in_array($segment2,array('create_installment')) ?"active":'') ?>">
                          <a href="<?php echo base_url('lead/create_installment'); ?>">
                           <?php echo 'Create Installment';?>                            
                          </a>
                        </li>

                        <li class="<?php echo (in_array($segment2,array('create_gst')) ?"active":'') ?>">
                          <a href="<?php echo base_url('lead/create_gst'); ?>">
                           <?php echo 'Create GST';?>                            
                          </a>
                        </li>

                        <li class="<?php echo (in_array($segment2,array('create_test_language')) ?"active":'') ?>">
                          <a href="<?php echo base_url('lead/create_test_language'); ?>">
                           <?php echo 'Create language Test';?>                            
                          </a>
                        </li>

                        <li class="<?php echo (in_array($segment2,array('create_visa_type')) ?"active":'') ?>">
                          <a href="<?php echo base_url('lead/create_visa_type'); ?>">
                           <?php echo 'Create Visa Type';?>                            
                          </a>
                        </li>

                        <li class="<?php echo (in_array($segment2,array('create_visa_mapping')) ?"active":'') ?>">
                          <a href="<?php echo base_url('lead/create_visa_mapping'); ?>">
                           <?php echo 'Visa Mapping';?>                            
                          </a>
                        </li>

                        <li class="<?php echo (in_array($segment2,array('create_edu')) ?"active":'') ?>">
                          <a href="<?php echo base_url('lead/create_edu'); ?>">
                           <?php echo 'Create Education';?>                            
                          </a>
                        </li>

                        <li class="<?php echo (in_array($segment2,array('url','add_url','edit_url')) ?"active":'') ?>" style="">
                          <a href="<?php echo base_url() ?>lead/url">
                           <?php echo 'Urls';?>                             
                          </a>
                        </li>

                        <li class="<?php echo (in_array($segment2,array('ticket_subjects','add_ticket_subjects','edit_ticket_subjects')) ?"active":'') ?>" style="">
                          <a href="<?php echo base_url() ?>lead/ticket_subjects">
                           <?php echo 'Ticket Subjects';?>                             
                          </a>
                        </li>

                        <li class="<?php echo (in_array($segment2,array('branch','add_branch','edit_branch')) ?"active":'') ?>" style="">
                          <a href="<?php echo base_url() ?>lead/branch">
                           <?php echo 'Branch Master';?>                             
                          </a>
                        </li>
                        ...
                        <li class="<?php echo (in_array($segment2,array('branch_master','add_branch_master','edit_branch_master')) ?"active":'') ?>" style="">
                          <a href="<?php echo base_url() ?>lead/branch_master">
                           <?php echo 'Branch Master Mapping';?>                             
                          </a>
                        </li>
         ...
         <li class="treeview" style="<?php if(in_array(440,$module) || in_array(441,$module) || in_array(442,$module) || in_array(443,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                     <a href="#">
                      <i class="fa fa-cart-plus" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> E-commerce
                      <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                      </span>
                  ...
                  if (user_access('470')) { ?>
                    <li class="treeview <?php echo (($segment1 == "product") ? "active" : null) ?>">
                      ...
                      <i class="fa fa-list-alt" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo 'Product'; ?>                     
                    </a>
                    </li>
                  <?php
                  }
                  ...
                  <li class="<?php echo (($segment1 == "inventory") ? "active" : null) ?>">
                    <a href="<?php echo base_url("warehouse/inventory") ?>">
                      <i class="fa fa-object-group" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo 'Inventory List'; ?>   
                    </a>
                  </li>
                  <?php
                  }
                  ...
                  <li class="<?php echo (($segment1 == "order") ? "active" : null) ?>">
                    <a href="<?php echo base_url("order/"); ?>">
                      <i class="fa fa-list" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo 'Order'; ?>                        
                    </a>
                  </li>
                  <?php
                  }
                  ...
                  <li class="<?php echo (($segment1 == "buy") ? "active" : null) ?>">
                    <a href="<?php echo base_url("buy/"); ?>">
                      <i class="fa fa-shopping-bag" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo 'Buy'; ?>
                    </a>
                  </li>
                  <?php
                  }
                      ...
                      ?>
                        <li class="<?php echo ((!empty($_GET['c']) && $_GET['c'] == $ind) ? "active" : null) ?> <?php echo ($treemenu == true) ? "treeview" : ""; ?>">                
                              ...
                              <?php }else{ ?>
                               ...
                               <i class="fa fa-list-alt" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo $ctg['title']; ?>   <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                            </span>
                ...
                <?php   }
                  ...
                  <li class="treeview <?php echo in_array($segment1, array('user','customer')) ? "active" : null ?>" style="<?php if(in_array(130,$module) || in_array(131,$module) || in_array(132,$module) || in_array(133,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                     <a href="#">
                       <i class="fa fa-user-plus" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('User_mgment') ?>
                       <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                       </span>
           <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('User_mgment'); ?></p> <?php } ?>  
                     ...
                     <!-- <?=$segment1?> -->
                     <ul class="treeview-menu <?php echo in_array($segment1, array('user','customer')) ? "menu-open" : null ?>">
                        <?php
                        if ($this->session->user_right == 1) {                        
                        ?>
                        <li class="<?php echo (in_array($segment2,array('customer','create','edit','')) ?"active":'') ?>"><a href="<?php echo base_url("customer"); ?>"><?php echo display('company_list'); ?></a>
                        </li>

                <!---      <li class="<?php //echo (in_array($segment2,array('backupDatabase')) ?"active":'') ?>"> <a  href="<?php //echo base_url("dashboard/backupDatabase"); ?>">Backup Databse</a>
                        </li>
                      ...
                      <?php
                        ...
                        <li class="<?php echo ($segment1=='user' && in_array($segment2,array('user_type','edit_user_role','permissions')) ?"active":'') ?>" style="<?php if(in_array(140,$module) || in_array(141,$module) || in_array(142,$module)|| in_array(143,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                          ...
                          <li class="<?php echo ($segment1=='user' && in_array($segment2,array('user_tree')) ?"active":'') ?>" style="<?php if(in_array(130,$module)||in_array(131,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>"><a href="<?php echo base_url("user/user_tree") ?>"><?php echo 'User Hierarchy' ?></a>
                           </li> 
                          <?php
                        }
                        ?>
                  ...
                  if ($this->session->user_right == 1) { ?>                    
                    ...
                    <a href="<?php echo base_url("form/form/tabs") ?>">
                        <i class="fa fa-cogs" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo 'TABS Settings' ?>
          <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo 'TABS Settings' ?></p> <?php } ?> 
          </a>
                    </li>
                  <?php
                  }
                  ...
                  <li class="treeview <?php echo (($segment1 == "whatsappapi" || $segment1 == "smsapi" || $segment1 == "configurations" ||$segment1 == "emailapi" || $segment2=='remindermsg') ? "active" : null) ?>"  style="<?php if(in_array(50,$module) || in_array(51,$module) || in_array(52,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                     <a href="#">
                      <i class="fa fa-cog" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('api') ?>
                      <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                      </span>
            <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('api') ?></p> <?php } ?>
                     </a>
                     ...
                     <ul class="treeview-menu">
                        ...
                        <li class="<?php echo (($segment1 == "smsapi" && $segment2 == " ") ? "active" : null) ?>">
                        ...
                        <li class="<?php echo (($segment1 == "configurations" && $segment2 == "index") ? "active" : null) ?>">
                          <a href="<?php echo base_url("configurations/index") ?>"><?php echo display('website') ?></a>
                        </li>
                        ...
                        <li class="<?php echo (($this->uri->segment(2) == "payment_gatway") ? "active" : null) ?>">
                          <a href="<?php echo base_url("configurations/payment_gatway") ?>"><?php echo display('payment_gatway') ?></a>
                        </li>
                        <li class="<?php echo (($this->uri->segment(2) == "notitemp_setting") ? "active" : null) ?>">
                          <a href="<?php echo base_url("smsapi/notitemp_setting") ?>"><?php echo display('notification_template') ?></a>
                        </li>
                        <li class="<?php echo (($this->uri->segment(2) == "remindermsg") ? "active" : null) ?>">
                          <a href="<?php echo base_url("setting/remindermsg") ?>"><?php echo display('reminder_template') ?></a>
                        </li>   
                        <?php
                  ...
                  <li class="treeview <?php echo (($segment1 == "enq" || ($segment1 == "enquiry" && $segment2 == "view" || $segment2 == "create")) ? "active" : null) ?>" style="<?php if(in_array(60,$module) || in_array(61,$module) || in_array(62,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                    <a href="<?php echo base_url("enq/index") ?>">
                    <i class="fa fa-question-circle-o" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('enquiry') ?>
                  ...
                  <li class="<?php echo ($segment1 == "led" || $segment2 == 'lead_details') ? "active" : null ?>" style="<?php if(in_array(70,$module) || in_array(71,$module) || in_array(72,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">

                    <a href="<?php echo base_url("led/index") ?>">
                    <i class="fa fa-line-chart" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('lead') ?>
          <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('lead') ?></p> <?php } ?>
          </a>
                  ...
                  <li class="<?php echo (($segment1 == "client" && empty($_GET['stage'])) ? "active" : null) ?>" style="<?php if(in_array(80,$module) || in_array(81,$module) || in_array(82,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                    ...
                    <i class="fa fa-user-circle-o" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('client') ?>
          ...
          <li class="<?php echo (($segment1 == "refund" && ($segment2 == "index" || $segment2 == "view") && empty($_GET['stage'])) ? "active" : null) ?>" style="<?php if(in_array(740,$module) || in_array(741,$module) || in_array(742,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                    <a href="<?php echo base_url("refund/index") ?>">
                    <i class="fa fa-retweet" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('refund_list') ?>
          <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('refund_list') ?></p> <?php } ?>
          </a>

                  </li>

                  <li class="<?php echo (($segment1 == "refund" && $segment2 == "pay_list" && empty($_GET['stage'])) ? "active" : null) ?>" style="<?php if(in_array(780,$module) || in_array(781,$module) || in_array(782,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                    <a href="<?php echo base_url("refund/pay_list") ?>">
                    <i class="fa fa-google-wallet" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('payment_list') ?>
          <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('payment_list') ?></p> <?php } ?>
          </a>
                     ...
                     foreach ($enquiry_separation as $key => $value) { ?>                        
                         <li class="<?php echo (($segment1 == "client") && (!empty($_GET['stage']) && $_GET['stage'] == $key) ) ? "active" : null ?>" style="<?php if(in_array(80,$module) || in_array(81,$module) || in_array(82,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                          <a href="<?php echo base_url("client/index?stage=").$key ?>">
                            <i class="<?=$value['icon']?>" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo $value['title'] ?>
                            <?php  
                  ...
                  <li class="<?php echo (($segment1 == "task") ? "active" : null) ?>" style="<?php if(in_array(90,$module) || in_array(91,$module) || in_array(92,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                    <a href="<?php echo base_url("task/index") ?>">
                    <i class="fa fa-calendar" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('task') ?>
          <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('task') ?></p> <?php } ?>
          </a>
                  </li>
                  ...
                  <li class="treeview <?php echo (($segment1 == "whatsappapi" || $segment1 == "smsapi" || $segment1 == "configurations" ||$segment1 == "emailapi") ? "active" : null) ?>"  style="<?php if(in_array(210,$module) || in_array(211,$module) || in_array(212,$module) || in_array(213,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                     <a href="#">
                      <i class="fa fa-cog" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;Forecasting
                      <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                      </span>
            <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo 'Forecasting'; ?></p> <?php } ?>
                     </a>
                ...
                <li class="treeview <?php echo (($segment1 == "report") ? "active" : null) ?>"
                        style="">
                        <a href="#">
                            <i class="fa fa-bar-chart icon-class" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i>&nbsp;<?php echo display('report'); ?>
                            <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('report') ?></p> <?php } ?>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            ...
                            ?>
                            <li
                                class="<?php echo (($segment1 == "report" & $segment2=='index' ) || ( $segment1 == "report" && $segment2=='view_details' ) ? "active" : null) ?>">
                                <a href="<?=base_url("report/index") ?>">Sales Report </a>
                            </li>
                            <?php
                            }
                            if(user_access('760'))
                            {
                            ?>
                            <li class="<?php echo (($segment1 == "report") && $segment2=='account_report_list' ? "active" : null) ?>">
                                <a href="<?=base_url("report/account_report_list") ?>">Accounts Mgmt Report </a>
                            </li>
                            <?php
                            }                             
                            if(user_access('750'))
                            {
                            ?>
                            <li class="<?php echo (($segment1 == "report") && $segment2=='case_report_list' ? "active" : null) ?>">
                                <a href="<?=base_url("report/case_report_list") ?>">CASE Mgmt Report </a>
                            </li>
                            <?php
                            }
                            if(user_access('770'))
                            { 
                            ?>
                            <li class="<?php echo (($segment1 == "report") && $segment2=='legal_report_list' ? "active" : null) ?>">
                                <a href="<?=base_url("report/legal_report_list") ?>">Legal dept Report </a>
                            </li>
                            <?php
                            }
                            if(user_access('430'))
                            { 
                            ?>
                            <li class="<?php echo (($segment1 == "report") && $segment2=='call_report' ? "active" : null) ?>">
                                <a href="<?=base_url("report/call_report") ?>">Call Report </a>
                                <!--<a href="<?=base_url("call_report/index") ?>">Call Report </a>-->
                            </li>
                            <?php
                            } 
                            ?>
                ...
                <li class="treeview"
                        style="">
                        <a href="#">
                            <i class="fa fa-bar-chart icon-class" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i>&nbsp;Transaction Details
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                          <li class="">
                                <a href="<?=base_url("transaction/sms") ?>">SMS Transaction </a>
                          </li>
                          <li class="">
                                <a href="<?=base_url("transaction/email") ?>">Email Transaction </a>
                          </li>
                          <li class="">
                                <a href="<?=base_url("transaction/whatsapp") ?>">Whatsapp Transaction </a>
                          </li>
                          <li class="">
                                <a href="<?=base_url("transaction/telephonic") ?>">Telephonic Transaction </a>
                          </li>
            ...
            <li  class="treeview <?php echo (($segment2 == "file_manager") ? "active" : null) ?>" style="<?php if(in_array(520,$module) || in_array(521,$module) || in_array(522,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                     <a href="<?php echo base_url('location/file_manager')?>">
                      <i class="fa fa-folder-open-o" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('file_manager'); ?> 
           <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('file_manager') ?></p> <?php } ?> 
           </a>
            </li>
                  ...
                  <?php if(in_array(200,$module) || in_array(201,$module) || in_array(202,$module) || in_array(203,$module)) { ?>
                   ...
                   <li class="treeview ">                     
                     <a href="#">
                      <i class="fa fa-cog" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('user_activity'); ?>
                      <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                      </span>
            <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('user_activity') ?></p> <?php } ?>
                     </a>

                     <ul class="treeview-menu">
                        <li class="<?php echo (($segment1 == "attendence" && in_array($segment2, array('logs'))) ? "active" : null) ?>">
                          <a href="<?php echo base_url("attendance/logs") ?>"><?php echo display('attendence') ?></a>
                        </li>                       
                     </ul>
                ...
                ?>
                  <li  class="treeview <?php echo (($this->uri->segment(1) == "knowledge_base") ? "active" : null) ?>" style="<?php if(in_array(170,$module) || in_array(171,$module) || in_array(172,$module) || in_array(173,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                          <a href="<?=base_url().'leave'?>">
                              <i class="fa fa-quora" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp; Knowledge Base 
                <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo 'Knowledge Base' ?></p> <?php } ?>
                          </a>
                          <ul class="treeview-menu <?php echo (($this->uri->segment(1) == "knowledge_base") ? "active" : null) ?>">
                  ...
                  <li class="treeview <?php echo (($segment1 == "invoice") ? "active" : null) ?>" style="<?php if(in_array(180,$module) || in_array(181,$module) || in_array(182,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                     <a href="<?php echo base_url("invoice/invoice/index") ?>">
                       <i class="fa fa-paper-plane-o" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('invoice') ?>
           <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('invoice') ?></p> <?php } ?>
           </a>

                     <ul class="treeview-menu <?php echo (($this->uri->segment(1) == "invoice") ? "active" : null) ?>">
                        <?php if(user_access('180')==true||user_access('181')==true||user_access('182')==true||user_access('183')==true){?>
                          <li class="<?php echo (($segment2 == "invoice" && $segment3 == "index") ? "active" : null) ?>"><a href="<?=base_url('invoice/invoice/index')?>">Invoice List</a></li>
                          <li class="<?php echo (($segment2 == "invoice" && $segment3 == "create") ? "active" : null) ?>"><a href="<?php echo base_url('invoice/invoice/create')?>">Create Invoice</a></li>
                          <li class="<?php echo (($segment2 == "invoice" && $segment3 == "report") ? "active" : null) ?>"><a href="<?php echo base_url('invoice/invoice/report')?>">Invoice Report</a></li>
                          <li class="<?php echo (($segment2 == "invoice" && $segment3 == "settings") ? "active" : null) ?>"><a href="<?php echo base_url('invoice/invoice/settings')?>">Invoice Settings</a></li>
                          <?php }?>                                
                      </ul>

                  </li>

                  <li class="treeview <?php echo (($segment1 == "language") ? "active" : null) ?>" style="<?php if(in_array(190,$module) || in_array(191,$module) || in_array(192,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                    <a href="<?php echo base_url("language/index") ?>"><i class="fa fa-language" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('language_setting') ?>
          <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('language_setting') ?></p> <?php } ?>
          </a>
                  </li>
                
        <li class="treeview <?php echo (($segment1 == "schedule") ? "active" : null) ?>" style="<?php if(in_array(320,$module) || in_array(321,$module) || in_array(322,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                    <a href="<?php echo base_url("schedule/index") ?>"><i class="fa fa-language" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('schedule') ?>
...
<?php if(in_array($this->session->userdata('user_right'), applicant)){ ?>
          <li class="treeview <?php echo (($segment1 == "ticket") ? "active" : null) ?>" style="<?php if(in_array(310,$module) || in_array(311,$module) || in_array(312,$module) || in_array(313,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                    <a href="<?php echo base_url("ticket/index") ?>"><i class="fa fa-tasks" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('ticketing') ?>
...
<?php }else{ ?>       
    <li class="treeview <?php echo (($segment1 == "ticket" || $segment1 == "smsapi") ? "active" : null) ?>"  style="<?php if(in_array(310,$module) || in_array(311,$module) || in_array(312,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                     <a href="#">
                      <i class="fa fa-tasks" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('ticketing') ?>
                      <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                      </span>
            <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('ticketing') ?></p> <?php } ?>
...
<?php } ?>        
        <li class="treeview <?php echo (($segment1 == "appointment") ? "active" : null) ?>" style="<?php if(in_array(330,$module) || in_array(331,$module) || in_array(332,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                    <a href="<?php echo base_url("appointment/index") ?>"><i class="fa fa-language" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('appointment') ?>
          ...
          <li class="treeview <?php echo (($segment2 == "search_programs") ? "active" : null) ?>" style="<?php if(in_array(380,$module) || in_array(381,$module) || in_array(382,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                    <a href="<?php echo base_url("dashboard/search_programs") ?>"><i class="fa fa-search" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('search_program') ?>
    ...
    <?php if(in_array($this->session->userdata('user_right'), applicant)){ ?>
          ...
          <li class="treeview <?php echo (($segment2 == "meeting_room") ? "active" : null) ?>" style="<?php if(in_array(410,$module) || in_array(411,$module) || in_array(412,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                    <a href="<?php echo base_url("dashboard/meeting_room") ?>"><i class="fa fa-heart-o" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('meeting_room') ?>
          ...
          <li class="treeview <?php echo (($segment2 == "user_profile") ? "active" : null) ?>" style="<?php if(in_array(340,$module) || in_array(341,$module) || in_array(342,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                    <a href="<?php echo base_url("dashboard/user_profile") ?>"><i class="fa fa-user" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('user_profile') ?>
          <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('user_profile') ?></p> <?php } ?>
          </a>
                  </li>
          
          <li class="treeview <?php echo (($segment2 == "my_applications") ? "active" : null) ?>" style="<?php if(in_array(400,$module) || in_array(401,$module) || in_array(402,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                    <a href="<?php echo base_url("dashboard/my_applications") ?>"><i class="fa fa-heart-o" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('my_applications') ?>
          <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('my_applications') ?></p> <?php } ?>
          </a>
          </li>

          <li class="treeview <?php echo (($segment2 == "my_applicants") ? "active" : null) ?>" style="<?php if(in_array(420,$module) || in_array(421,$module) || in_array(422,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                    <a href="<?php echo base_url("dashboard/my_applicants") ?>"><i class="fa fa-heart-o" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('my_applications') ?>
          <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('my_applicants') ?></p> <?php } ?>
          </a>
          </li>
    <?php } ?>
      ...
      <!--      <li class="treeview <?php echo (($segment1 == "setting") ? "active" : null) ?>" style="display:block">
          ...
          <li class="treeview <?php echo (($this->uri->segment(1) == "website") ? "active" : null) ?>" style="<?php if(in_array(490,$module) || in_array(491,$module) || in_array(492,$module)){ echo 'display:block;';}else{echo 'display:none;';}?>">
                            <a href="#">
                                <i class="pe-7s-global" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo display('website') ?>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                <?php  if($this->session->menu==1){ ?></br><p style="color:#fff;font-size:9px;margin-left:-12px;padding-top:10px;"><?php echo display('website') ?></p> <?php } ?>
                            </a>
                            <ul class="treeview-menu">
                          ...
                          ?>
                            <li class="<?php echo (($segment1 == 'chat') ? "active" : null) ?>">
                              ...
                              <i class="fa fa-comment" style="color:#fff;font-size:17px;background:#43AEEF;padding:7px 7px 7px 7px;border-radius:4px;width:30px;"></i> &nbsp;<?php echo 'Chat' ?>
       ...
       <?php } ?>
         <!-- =============================================== -->
         <div class="<?php if(!in_array($this->session->userdata('user_right'), applicant)){ echo 'content-wrapper';}; ?>" style="">
...
@media(max-width: 576px) {
         ...
         <footer class="main-footer" style="margin-left: unset; text-align: center;color: black;font-size: 12px;display:block;padding:5px;z-index:999;">
          <?php if($comp_id==88){
              $web = 'Croyez Immigration'; 
          }else if($comp_id==83){
              $web = 'Godspeed Immigration';
          }else{
              $web = 'Archiz';
          } ?>  
            Copyright © 2020.All Rights Reserved By <?php echo $web; ?>. Developed by Archiz Solutions    
        </footer>
      </div>
...
*/
  ...
  var config = {
      ...
      apiKey: "AIzaSyDQdC4TMYGUjbdBj9ULlBWUGyZibZfsElQ",
      authDomain: "godspeed-11e92.firebaseapp.com",
      databaseURL: "https://godspeed-11e92.firebaseio.com",
      storageBucket: "godspeed-11e92.appspot.com",
  }
...
starCountRef1.on('value',function(res){
        ...
        if (typeof myVar !== 'undefined') {
          var phone=Object.values(res.val());
           ...
           console.log(phone_s);   
          var user_pho="<?php echo $this->session->phone;?>";
          //alert(uid);
              if(phone_s == user_pho){
           $.ajax({
                  type: "POST",
...
<script type="text/javascript">
  /*----------------------------------------agreement notification------------------------*/
    $.ajax({
       url: "<?php echo base_url();?>notification/web/get_agreement_notification",
       dataType : "json",        
       success: function(data){
       var l = data.length;
          var i;
      for (i = 0; i < l; i++) {
        var agrid = data[i]['id'];
                 Swal.fire({
                      ...
                      text:  data[i]['applicant_name']+' not fill agreement need to followup',
                      icon: "info",
                      confirmButtonColor: '#3085d6',
                      confirmButtonText: 'ok'
                    }).then((result) => {
  if (result.isConfirmed) {
    $.ajax({
        type: 'POST',
        url: '<?php echo base_url();?>notification/web/update_agreement_status/'+agrid,
      })
    Swal.fire(
      'Great Work',
      'Mark As Read.',
...
/***********************payment reminder FOR Applicant notification Start*************************/
var kwd=btoa('<?php echo $this->session->phone; ?>');
     $.ajax({
        type: 'POST',
        url: '<?php echo base_url();?>lead/get_payment_notification',
        data: {kwd:kwd},
      })
      .done(function(data){
       if(data){
...
/*************************payment reminder notification End***********************/
</script>
<?php } ?>
 <?php if(!in_array($this->session->userdata('user_right'), applicant)){ ?>
<script type="text/javascript">
  /*----------------------------------------Payment notification for Admin lavel Start------------------------*/
    $.ajax({
       url: "<?php echo base_url();?>notification/web/get_payment_notification",
       dataType : "json",        
       success: function(data){
       var l = data.length;
          var i;
      for (i = 0; i < l; i++) {
        var payid = data[i]['id'];
                 Swal.fire({
                      ...
                      text:  'We wish to inform you that an payment of applicant '+data[i]['name_prefix']+' '+data[i]['name']+' '+data[i]['lastname']+' and payment date '+data[i]['pay_date']+' of amount '+data[i]['pay_amt']+' is Pending. If already notify about that please ignore. GODSPEED IMMIGRATION & STUDY ABROAD PVT LTD.',
                      icon: "info",
                      confirmButtonColor: '#3085d6',
                      confirmButtonText: 'ok'
                    }).then((result) => {
  if (result.isConfirmed) {
    $.ajax({
        type: 'POST',
        url: '<?php echo base_url();?>notification/web/update_payment_status/'+payid,
      })
    Swal.fire(
      'Great Work',
      'Mark As Read.',
...
/*------------------------------Payment notification for Admin lavel End-----------------------*/
</script>
<?php } ?>
