...
if($root=='https://crm.croyezacademy.com'){	 ?>	
    <link rel="icon" href="<?php echo base_url('assets/images/fav_croyez.png'); ?>" sizes="32x32" />
<?php }else if($root=='https://desk.godspeedvisa.com'){ ?>
<link rel="icon" href="<?php echo base_url('assets/images/godspeed.png'); ?>" sizes="32x32" />
<?php }else{ ?>
...
<?php } ?>
    ...
    <body data-baseUrl="<?php echo base_url(); ?>" style='background: white;'>
        ...
        <div class="login-wrapper"> 
            ...
            <?php $root=(isset($_SERVER["HTTPS"]) ? "https://" : "http://").$_SERVER["HTTP_HOST"];
            if($root=='https://crm.croyezacademy.com'){	 ?>	
                <img style="width: 26%;" src="<?php echo base_url('assets/images/logo_cryez.png'); ?>" class="m-r-sm">
            <?php }else if($root=='https://desk.godspeedvisa.com'){ ?>
                <img style="width: 14%;" src="<?php echo base_url('assets/images/godspeed.png'); ?>" class="m-r-sm">
           <?php }else{ ?>
                <!--<img style="width: 14%;" src="<?php echo base_url('assets/images/godspeed.png'); ?>" class="m-r-sm">-->
                    ...
                    <div class="panel-heading">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                <h3 style="color: #37a000;"><?= display('please_login') ?></h3>
                            </div>
                        </div>
                        <div class="">
                        <br><br>
