            ...
            <div class="dropdown-menu" style="max-height: 400px; overflow: auto; position: absolute; will-change: transform; top: 26px; left: 0px; margin-left: -110px; transform: translate3d(0px, -7px, 0px);" x-placement="top-start">
               <ul style="list-style-type:none;">
                   <li><label><input type="checkbox" onclick="hide_td('th0','tt0')" id="tt0" checked> S.No.</label></li>
                    ...
                    <li><label><input type="checkbox" onclick="hide_td('th2','tt2')" id="tt2" checked> API Key</label></li>
...
<div id="createnewintegration<?php echo $list->api_id;?>" class="modal fade" role="dialog">
 ...
 <!---------------------------------------------------------------->
    ...
    <div class="tab-pane" id="tab-templates">
     ...
     &nbsp; 
     &nbsp; 
      <button class="btn btn-sm btn-primary" type="button" data-toggle="modal" data-target="#updateautoMessage"><i class="fa fa-plus"></i> Update Auto Message Template</button>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div id="updateautoMessage" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Send Auto Whatsapp Notifications</h4>
      </div>
      <div class="modal-body">
                             ...
                             <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type" id="type" >
                                        <option value="6">Website form Submit</option>
                                    </select>
                                </div>
                                </div>
                                <div class="col-md-12">
