...
<!------ Filter Div ---------->
  ...
  <option value="4" <?php if(!empty(set_value('state'))){ if (in_array('4',set_value('state'))) {echo 'selected';}}?>>Refund Case</option>
                ...
                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Registration Fee',set_value('report_columns'))) {echo 'selected';}}?>>Registration Fee</option>

                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Family Fee',set_value('report_columns'))) {echo 'selected';}}?>>Family Fee</option>

                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Lawyer Fee',set_value('report_columns'))) {echo 'selected';}}?>>Lawyer Fee</option>

                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Consultancy Fee',set_value('report_columns'))) {echo 'selected';}}?>>Consultancy Fee</option>

                <option <?php if(!empty(set_value('report_columns'))){if (in_array('Stamp Paper Fee',set_value('report_columns'))) {echo 'selected';}}?>>Stamp Paper Fee</option>
 ...
 $("#filter_and_save_form").on('submit',function(e){
  ...
  $(document).ready(function(){   
    ...
    $('#example').DataTable({         
      ...
      "ajax": {
          "url": "<?=base_url().'report/all_report_filterdata/1'?>",
          "type": "POST",
      },    
...
$("#filter_and_save").on("click",function(e){
  ...
  if(title){    
    var url = "<?=base_url().'report/create_report/1'?>";
    $.ajax({
      url:url,
      type:'POST',
      data:{
