...
<hr class="line_break">
<!------------------------------------------userwise email settings form start------------------------------------------->
                                <div class="form-group col-md-4">
                                    <label for="description">SMTP Protocol </label>
                                    <input name="user_protocol" id="user_protocol"  type="text" class="form-control"  value="<?php echo $department->user_protocol;?>">
                                    
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="description">SMTP Host </label>
                                    <input name="user_host" id="user_host"  type="text" class="form-control"  value="<?php echo $department->user_host;?>">
                                    
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="description">SMTP Port </label>
                                    <input name="user_port" id="user_port"  type="text" class="form-control"  value="<?php echo $department->user_port;?>">
                                    
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="description">SMTP Email </label>
                                    <input name="user_email" id="user_email"  type="text" class="form-control"  value="<?php echo $department->user_email;?>">
                                    
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="description">SMTP Password </label>
                                    <input name="user_password" id="user_password"  type="text" class="form-control"  value="<?php echo $department->user_password;?>">
                                    
                                </div>
<!------------------------------------------userwise email settings form end------------------------------------------->
<hr class="line_break">
<!------------------------------------------userwise Whatsapp settings form------------------------------------------->
                                <div class="form-group col-md-4">
                                    <label for="description">Whatsapp Key </label>
                                    <input name="whatsapp_api" id="whatsapp_api"  type="text" class="form-control"  value="<?php echo $department->whatsapp_api;?>">
                                    
                                </div>
<!------------------------------------------userwise Whatsapp settings form end------------------------------------------->
                                      ...
                                      <option value=''>---Select Branch----</option>
                                        <?php  if (!empty($all_branch)) {
                                            foreach ($all_branch as $key => $value) { ?>
                                                <option value="<?= $value->id;?>" <?php if($value->id == $department->sales_branch){ echo "selected";} ?>><?= $value->b_name;?></option>
                                            <?php
                                            }
                                        } ?>
                                    </select>
                                </div>
<!------------------------------Telephony field setup Start--------------------------->
<hr class="line_break">
                                  <?php
                                  if (user_access(220)) { ?>

                              <div class="form-group col-md-4">
                                      <label class="control-label"><?php echo 'Telephony Number';?></label>
                                      <input type="test" name="telephony_agent_no" value="<?php echo $department->telephony_agent_no;?>" class="form-control">
                              </div> 

                                <div class="form-group col-md-4">
                                    <label class="control-label" for="telephony_type"><?=display('telephony_type')?></label>
                                      <select class="form-control" name="telephony_type" id="telephony_type">
                              <option value=''>---Select Type----</option>
                          <option value="1" <?php if($department->telephony_type=='1'){ echo "selected";} ?>>Ameyo</option>
                      <option value="2" <?php if($department->telephony_type=='2'){ echo "selected";} ?>>Tata Tale</option>
                      <option value="3" <?php if($department->telephony_type=='3'){ echo "selected";} ?>>C-Zentrix</option>
                      <option value="3" <?php if($department->telephony_type=='4'){ echo "selected";} ?>>Myoperator</option>                </select>
                                </div>

                                    <div class="form-group col-md-4">
                                      <label class="control-label"><?php echo display('telephony_agent_id');?></label>
                                      <input type="test" name="telephony_agent_id" value="<?php echo $department->telephony_agent_id;?>" class="form-control">
                                    </div> 

                                    <div class="form-group col-md-4">
                                      <label class="control-label"><?php echo 'Telephony Login Id';?></label>
                                      <input type="test" name="telephony_login_id" value="<?php echo $department->telephony_login_id;?>" class="form-control">
                                    </div>

                                    <div class="form-group col-md-4">
                                      <label class="control-label"><?php echo 'Telephony Password';?></label>
                                      <input type="test" name="telephony_agent_pass" value="<?php echo $department->telephony_agent_pass;?>" class="form-control">
                                    </div>                                                                                                                   
                                  <?php
                                  }
                                  ?>
<hr class="line_break">
<!------------------------------Telephony field setup End--------------------------->                                
                    ...
                    <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <select data-placeholder="Begin typing a name to filter..." multiple class="form-control chosen-select" name="process[]" multiple>
                                        <?php
                                        if (!empty($products)) {
