...
class Telephony extends CI_Controller {
   ...
   public function get_call_status($uid=''){
	...
	public function cntrix_dail($phone='',$enq=''){
		
	 $url="https://czagent.c-zentrixcloud.com/apps/appsHandler.php?transaction_id=CTI_DIAL&agent_id=".$this->session->telephony_agent_id."&phone_num=".$phone."&ip=&resFormat=3";
